...
{
    CommunicationFrame (Socket s, byte userId, String database, byte[] key) throws IOException
    {
        this.serverCookie    = 0;
        ...
        this.rawFrameSize = cipher.prepareAuthResponse (this.rawFrame, database, key);

        this.rawFrame.putShort(_c.FRAME_SIZE_OFF, (short) this.rawFrameSize);
        oStream.write (this.rawFrame.array (), 0, this.rawFrameSize);
    ...
    final void sendCommand (short cmd, boolean waitForAnswer) throws IOException
    {
        ...
        this.clientCookie = randomGenerator.nextInt ();
