...
public class TestWhaisConstants
{
    ...
    public static void main (String[] args) throws IOException
    {
        ...
        TestWhaisConstants test = new TestWhaisConstants ();
        ...
        testResult &= test.executeTest( c, "pi", Value.createRichReal("3.14159265358979"));
        testResult &= test.executeTest( c, "phi", Value.createRichReal("1.61803398874989"));
        testResult &= test.executeTest( c, "e", Value.createRichReal("2.71828182845904"));
        testResult &= test.executeTest( c, "sqrt2", Value.createRichReal("1.41421356237309"));
    ...
    public boolean executeTest(final Connection c, final String api, final Value v) {
        ...
        if ( ! result.equals( v)) {
            System.out.println(result.toString() + " (expected: " + v + ") ...  FAIL");
